...
export const EstreexTypeError = class extends TypeError {
  constructor(/** @type {never} */ cause) {
    super("unsound type");
    this.name = "EstreexSyntaxError";
    this.cause = /** @type {any} */ (cause);
  }
};

export const EstreexSyntaxError = class extends SyntaxError {
...
const formatExpect = (expect, budget) => {
  if (typeof expect === "string") {
    ...
    throw new EstreexTypeError(expect);
  }
};
