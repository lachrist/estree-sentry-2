 ...
 *   import("../syntax/template").TaggedTemplateExpression<{}>
 * >}
 */
...
/**
 * @type {import("../guard").Subguard<
 *   import("../syntax/template").TemplateLiteral<{}>
 * >}
 */
...
/**
 * @type {import("../guard").Guard<
 *   import("../syntax/template").TemplateElement<{}>
 * >}
 */
const guardTemplateElement = (node, path, annotate) => {
  ...
  return {
    ...
    value: {
      raw: /** @type {import("../syntax/template").TemplateElementRawValue} */ (
        getString(value, "raw", path, kind)
      ),
      cooked: has(value, "cooked")
        ? /** @type {import("../syntax/template").TemplateElementValue} */ (
