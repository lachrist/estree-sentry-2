...
import { subguardLiteral } from "./literal.mjs";
 ...
 *   import("./expression").Super<{}>
 * >}
 */
export const subguardSuper = (node, path, annotate, type, kind) => ({
  type,
 ...
 *   import("./expression").SuperableExpression<{}>
 * >}
 */
...
/**
 * @type {import("../guard").Subguard<
 *   import("./expression").SpreadElement<{}>
 * >}
 */
...
/**
 * @type {import("../guard").Guard<
 *   import("./expression").SpreadableExpression<{}>
 * >}
 */
...
/**
 * @type {import("../guard").Guard<
 *   import("./expression").PrivatableExpression<{}>
 * >}
 */
...
/**
 * @type {import("../guard").Guard<
 *   import("./expression").DeclarableExpression<{}>
 * >}
 */
...
export const subguardExpression = (node, path, annotate, type, kind) => {
  switch (type) {
    ...
    case "Literal": {
      return subguardLiteral(node, path, annotate, type, kind);
    }
